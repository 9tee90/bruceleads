...
export default function ReviewSetup() {
  ...
  const [userSelections, _setUserSelections] = useState({
    industry: 'Technology',
    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center px-6">
      ...
      <div className="bg-gray-900 p-6 rounded-lg mt-4 w-80 border border-gray-700 shadow-lg">
        <p className="text-white">
          <strong>Industry:</strong> {userSelections.industry}
        </p>
        <p className="text-white">
          <strong>Company Size:</strong> {userSelections.companySize}
        </p>
        <p className="text-white">
          <strong>Lead Intent:</strong> {userSelections.leadIntent}
        </p>
      </div>
