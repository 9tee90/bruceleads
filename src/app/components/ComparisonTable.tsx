...
const features = [
  {
    name: "AI-Powered Sales Triggers",
    description: "Real-time detection of company growth signals",
    bruce: true,
    apollo: false,
    seamless: false,
    clay: false,
  ...
  {
    name: "Ethical, No LinkedIn Ban Risk",
    description: "100% compliant with platform terms of service",
    bruce: true,
    apollo: false,
    seamless: false,
    clay: false,
  ...
  {
    name: "Real-time Company Monitoring",
    description: "Track hiring surges and funding rounds instantly",
    bruce: true,
    apollo: true,
    seamless: false,
    clay: true,
  },
  {
    ...
    description: "AI-driven message customization",
    bruce: true,
    apollo: true,
    seamless: true,
    clay: false,
  },
  {
    ...
    description: "Personal guidance and strategy optimization",
    bruce: true,
    apollo: false,
    seamless: true,
    clay: false,
  ...
  return (
    <div className="w-full px-4 sm:px-6">
      ...
      >
        ...
        <motion.div
          variants={rowVariants}
          className="bg-gray-50 p-4 sm:p-6 text-center"
        >
          <motion.button
